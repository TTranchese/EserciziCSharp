...
namespace EseLibriIdentity.Controllers
{
    public class EditoriController : Controller
    {
        private readonly ApplicationDbContext _context;

        public EditoriController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Denominazione")] Editore editore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Denominazione")] Editore editore)
        {
            if (id != editore.Id)
            {
                return NotFound();
